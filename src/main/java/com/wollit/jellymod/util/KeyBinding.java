...
public class KeyBinding {
    ...
    public static final KeyMapping CHOOSE_CLASS_KEY = new KeyMapping(KEY_CHOOSE_CLASS, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_L, KEY_CATEGORY);
