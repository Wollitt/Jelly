...
public class IdentificationTableMenu extends AbstractContainerMenu {
    public final IdentificationTableBlockEntity blockEntity;
    private final Level level;

    public IdentificationTableMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
