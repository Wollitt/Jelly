...
public class JellyMenuTypes {
    ...
    public static final RegistryObject<MenuType<CrystalAssemblerMenu>> CRYSTAL_ASSEMBLER_MENU =
            registerMenuType("crystal_assembler_menu", CrystalAssemblerMenu::new);
