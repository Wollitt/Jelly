...
public class CrystalAssemblerMenu extends AbstractContainerMenu {

    public final CrystalAssemblerBlockEntity blockEntity;
    private final Level level;

    public CrystalAssemblerMenu(int id, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public CrystalAssemblerMenu(int id, Inventory inventory, BlockEntity blockEntity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 8, 57));
            this.addSlot(new SlotItemHandler(handler, 1, 44, 57));
            this.addSlot(new SlotItemHandler(handler, 2, 80, 57));
            this.addSlot(new SlotItemHandler(handler, 3, 134, 57));
        });
